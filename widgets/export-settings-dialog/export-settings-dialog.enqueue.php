...
// add the js
wp_enqueue_script( 'pdqcsv-export-settings-dialog', plugin_dir_url(__FILE__) . 'export-settings-dialog.js', ['pdqcsv-combobox','jquery-ui-dialog','jquery-ui-mouse','jquery-ui-tabs'] );
...
wp_enqueue_style( 'pdqcsv-export-settings-dialog', plugin_dir_url(__FILE__) . 'export-settings-dialog.css' );
