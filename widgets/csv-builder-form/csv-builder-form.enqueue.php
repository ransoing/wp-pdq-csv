...
// add the js
wp_enqueue_script( 'pdqcsv-csv-builder-form', plugin_dir_url(__FILE__) . 'csv-builder-form.js', ['pdqcsv-multi-fields', 'pdqcsv-multi-filters', 'pdqcsv-export-settings-dialog', 'jquery-ui-button', 'jquery-ui-dialog', 'moment'], PDQCSV_VERSION );
