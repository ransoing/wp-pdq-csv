...
wp_enqueue_script( 'pdqcsv-csv-builder-form', plugin_dir_url(__FILE__) . 'csv-builder-form.js', ['pdqcsv-multi-fields', 'pdqcsv-multi-filters', 'pdqcsv-export-settings-dialog', 'jquery-ui-button', 'jquery-ui-dialog', 'momentjs'] );

// add the css
wp_enqueue_style( 'pdqcsv-spinner', plugin_dir_url(__FILE__) . '../spinner.css' );
wp_enqueue_style( 'pdqcsv-csv-builder-form', plugin_dir_url(__FILE__) . 'csv-builder-form.css' );
